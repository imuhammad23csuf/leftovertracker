...
void SerializeLeftoverRecordToJSON(
  ...
  food_name = record.GetFoodName();  // code
  ...
  quantity = record.GetQuantityInOz();  // Use the getter function to retrieve
                                        // the quantity
  ...
  leftover_reason = record.GetLeftoverReason();  // Use the getter function to
                                                 // retrieve the leftover reason
